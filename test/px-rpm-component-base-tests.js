...
function runBaseTests() {
  px_rpm_component_1 = document.getElementById('px_rpm_component_1');

  suite('Base Automation Tests for px-rpm-component', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-rpm-component fixture is created', function() {
      assert.isTrue(document.getElementById('px_rpm_component_1') !== null);
    });
